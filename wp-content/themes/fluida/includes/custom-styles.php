...
.fluida-stripped-table .main tr:nth-child(odd) td,
.fluida-stripped-table .main tr:nth-child(odd) th
...
%%scope%% p, %%scope%% ul, %%scope%% ol, %%scope%% dd,
%%scope%% pre, %%scope%% hr { margin-bottom: <?php echo esc_html( $fluida_paragraphspace ) ?>; }
%%scope%% p { text-indent: <?php echo esc_html( $fluida_parindent ) ?>;}
