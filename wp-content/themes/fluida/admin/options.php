...
'info_settings' => array(
	'plus_link' => array(
		...
		'desc' =>  sprintf( __('Find out what features you\'re missing out on and how the Plus version of %1$s can improve your site.', 'fluida'), cryout_sanitize_tnl(_CRYOUT_THEME_NAME) ),
		'section' => 'cryoutspecial-about-theme',
	),
	'support_link_faqs' => array(
		'label' => __('Theme Support', 'fluida'),
